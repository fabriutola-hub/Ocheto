...
import CurvedTitle from '@/components/layout/CurvedTitle';
          ...
          <div className="flex flex-col lg:flex-row items-center lg:items-center justify-between gap-10 lg:gap-6">
            ...
            >
              <motion.div variants={fadeInUp} className="relative">
                <motion.div
                  animate={animateInfinite ? { y: [0, -6, 0] } : undefined}
                  transition={{
                    duration: 6,
                    repeat: Infinity,
                    ease: 'easeInOut' as const,
            ...
            <div className="relative w-full lg:w-[54%] xl:w-[56%] h-[340px] sm:h-[460px] md:h-[560px] lg:h-[640px] xl:h-[720px] mt-2 lg:mt-0">
              ...
              >
                <motion.div
                  animate={animateInfinite ? { y: [0, -12, 0] } : undefined}
                  transition={{
                    duration: 6,
                    repeat: Infinity,
                    ease: 'easeInOut' as const,
