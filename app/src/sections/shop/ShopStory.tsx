            ...
            <div className="relative">
              ...
              >
                <motion.img
                  ...
                  alt="Finca de café en los Yungas paceños"
                ...
                >
                  ...
                  <p className="font-fraunces italic font-medium text-white text-2xl sm:text-3xl leading-tight">
                    A 1,800m sobre el nivel del mar.
                  </p>
                </motion.div>
              ...
              >
                ...
                <p className="font-caveat text-ocheto-coffee-900 text-lg sm:text-xl leading-tight">
                  "El mejor café nace en la altura"
                </p>
          ...
          >
            ...
            >
              ...
              <span className="relative inline-block">
                <span className="relative z-10 text-ocheto-green-700">Yungas</span>
                <span
                  aria-hidden
            ...
            <motion.div variants={fadeUp} className="mt-7 space-y-4">
              <p className="font-inter text-base sm:text-lg text-ocheto-coffee-700/85 leading-relaxed">
                Cada bolsa de Ocheto nace en una ladera de los Yungas paceños,
                donde pequeños productores cultivan café de altura desde hace
                generaciones. La tierra roja, el clima fresco y la lluvia
                constante hacen el resto.
              </p>
              <p className="font-inter text-base sm:text-lg text-ocheto-coffee-700/85 leading-relaxed">
                Seleccionamos los granos a mano, los tostamos en pequeños lotes
                cada lunes en nuestro horno{' '}
                <em className="font-fraunces italic text-ocheto-coffee-900/95">
                  Probat
                </em>{' '}
                y los empacamos antes de que salga el sol. Cero inventarios
                enormes, cero cafés de meses: solo lo fresco, lo honesto, lo que
                nosotros mismos tomamos.
              </p>
            </motion.div>
            ...
            >
              ...
              >
                <span>Conoce nuestra finca</span>
