    ...
    <>
      <motion.nav
        ...
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ease-out ${
          solid
            ? 'bg-[hsl(var(--ocheto-cream-50))]/80 backdrop-blur-2xl saturate-150 shadow-[0_8px_32px_-12px_rgba(18,52,18,0.18),inset_0_1px_0_0_rgba(250,247,240,0.6)] py-2.5'
            : 'bg-transparent py-4 md:py-5'
        }`}
      >
        {/* Gradient hairline under nav when solid */}
        {solid && (
          <span
            aria-hidden
            ...
            style={{
              background:
                'linear-gradient(90deg, transparent 0%, hsl(var(--ocheto-green-700) / 0.18) 18%, hsl(var(--ocheto-gold-500) / 0.28) 50%, hsl(var(--ocheto-green-700) / 0.18) 82%, transparent 100%)',
            }}
          />
        )}
        <div className="container-ocheto flex items-center justify-between gap-4">
          ...
          >
            <motion.img
              ...
              style={{
                filter: solid
                  ? 'drop-shadow(0 2px 6px rgba(27,94,32,0.18))'
          ...
          <div className="hidden md:flex items-center gap-0.5">
            ...
            <NavIcon label="Mi cuenta" href="#cuenta" solid={solid}>
