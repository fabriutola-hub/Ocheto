...
import { useCategoryImages, FALLBACK_CATEGORY_IMAGES } from '@/features/siteImages/queries';

type CategoryKey = 'cafe' | 'matcha' | 'specialty' | 'frio' | 'beans';
...
const CATEGORY_IMAGES: Record<CategoryKey, string> = FALLBACK_CATEGORY_IMAGES;
...
function CategoryCard({ id, number, variant = 'small' }: CategoryCardProps) {
  ...
  const image = (catImages?.[id] ?? CATEGORY_IMAGES[id]) as string;
    ...
    >
      ...
      <div className="relative container-ocheto">
        ...
        >
          ...
          >
            Café, matcha, frío y granos para llevar. Lo que tomarás mañana, lo
            tostamos hoy.
          </motion.p>
        </motion.div>
