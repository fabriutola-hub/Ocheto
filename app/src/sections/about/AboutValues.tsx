...
import { Sparkles, Coffee, Users, Heart, ArrowUpRight } from 'lucide-react';
...
const VALUES: Value[] = [
  {
    ...
    subtitle: 'Lo mejor en cada preparación',
    description:
      'Seleccionamos cuidadosamente cada ingrediente. Valoramos la calidad porque creemos que es la base de cada momento especial que queremos crear.',
  ...
  },
  {
    icon: Coffee,
    emoji: '☕',
    title: 'Dedicación en cada preparación',
    subtitle: 'El cuidado está en los detalles',
    description:
      'Cada bebida, cada postre y cada visita se prepara con dedicación. Cuidamos el proceso porque sabemos que los pequeños detalles marcan la diferencia.',
  ...
  },
  {
    ...
    subtitle: 'La calidez que nos define',
    description:
      'Los ositos, las promociones, los coleccionables, las sonrisas. Son los pequeños detalles los que convierten una visita en un momento para recordar.',
  ...
  },
  {
    icon: Users,
    emoji: '🤝',
    title: 'Un equipo, una comunidad',
    subtitle: 'Personas que creen en esto',
    description:
      'Detrás de cada tienda hay un equipo sólido que aporta experiencia, talento y compromiso. Es esa visión compartida la que mantiene viva la esencia Ocheto.',
    ...
    >
      ...
      <div className="relative z-10 container-ocheto">
        ...
        >
          ...
          >
            Cuatro principios que viven en cada decisión, cada preparación y cada momento que compartimos contigo.
          </motion.p>
        </motion.div>
        ...
        >
          <p className="font-caveat text-2xl sm:text-3xl text-ocheto-green-700 leading-none">
            valores que se sienten, se sirven y se comparten
          </p>
        </motion.div>
      </div>
    </section>
