      ...
      >
        <div className="container-ocheto w-full">
          ...
          >
            ...
            >
              Bebidas, postres y alfajores elaborados con ingredientes de
              calidad. Cada preparación, hecha con cariño en La Paz.
            </motion.p>
            ...
            >
              <span className="inline-flex items-center gap-1.5">
                ...
                <span className="text-ocheto-cream-50 font-bold">{PRODUCTS_COUNT}</span>
              ...
              <span className="inline-flex items-center gap-1.5">
                ...
                <span className="text-ocheto-cream-50 font-bold">6</span>
