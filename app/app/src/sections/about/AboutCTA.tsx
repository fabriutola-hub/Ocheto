...
const titleWords = ['¿Listo', 'para', 'disfrutar', 'los', 'pequeños', 'detalles?'];
    ...
    >
      ...
      <div className="relative z-10 container-ocheto">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            Tres tiendas en La Paz, los mismos ingredientes de calidad y el
            mismo cariño de siempre. Pasa, te servimos una{' '}
