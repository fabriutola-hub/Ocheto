...
const PILLS: PillConfig[] = [
  ...
  {
    key: 'cafe',
    label: 'Calientes con Café',
    description: CATEGORIES.cafe.description,
    Icon: Coffee,
  },
  {
    key: 'specialty',
    label: 'Creaciones Ocheto',
  ...
  },
  {
    key: 'sin_cafe',
    label: 'Sin Café',
    description: CATEGORIES.sin_cafe.description,
    Icon: CupSoda,
  },
  {
    key: 'frio',
  ...
  },
  {
    key: 'panaderia',
    label: 'Repostería',
    description: CATEGORIES.panaderia.description,
    Icon: Croissant,
  },
  {
    key: 'especialidades',
    label: '¡Pruébalo hoy!',
    description: CATEGORIES.especialidades.description,
    Icon: Heart,
  },
  {
    key: 'beans',
              ...
              return (
                <motion.button
                  ...
                  className={[
                    ...
                    isActive
                      ? 'text-ocheto-cream-50 shadow-[0_8px_24px_-8px_rgba(27,94,32,0.55)]'
